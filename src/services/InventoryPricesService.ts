    ...
    static async getPricesByVariantId(
        ...
        const [data, total] = await InventoryPricesRepository
            ...
            .select([
                ...
                "prices.price_base_stable",
                "prices.price_base_ref",
                "prices.tax_amount_local",
                "prices.tax_amount_stable",
                "prices.tax_amount_ref",
                "prices.cost_local",
                "prices.cost_stable",
                "prices.cost_ref",
                "prices.cost_avg_local",
                "prices.cost_avg_stable",
                "prices.cost_avg_ref",
                "prices.profit_local",
                "prices.profit_stable",
                "prices.profit_ref",
